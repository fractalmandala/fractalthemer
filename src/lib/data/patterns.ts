// 257 Curated CSS Background Patterns by Category
export type PatternCategory = "geometric" | "effects" | "gradients" | "decorative";
...
export const PATTERN_CATEGORIES: { id: PatternCategory; label: string; count: number; icon: string }[] = [
  { id: "geometric", label: "Geometric", count: 99, icon: "📐" },
  { id: "effects", label: "Effects", count: 66, icon: "✨" },
  { id: "gradients", label: "Gradients", count: 48, icon: "🌈" },
  { id: "decorative", label: "Decorative", count: 44, icon: "🎨" }
];
